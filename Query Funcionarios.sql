...
SELECT F.Nombre, F.Apellido, F.Correo, FA.CodigoFuncionario, FA.FuncionarioID, FA.AreaID--, HD.Dia, HD.HoraIngreso, HD.MinutoIngreso, HD.HoraSalida, HD.MinutoSalida
FROM Funcionario F 
