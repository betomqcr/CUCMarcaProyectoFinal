<%@ Page Title="" Language="C#" MasterPageFile="~/CUC.Master" AutoEventWireup="true" CodeBehind="FrmTipoIdentificacion.aspx.cs" Inherits="CUCMarca.Administracion.Matenimientos.FrmTipoIdentificacion" %>
            ...
            <asp:MultiView ID="mvMain" runat="server">
                <asp:View ID="viewDatos" runat="server">
                    <div class="card mb-4 py-3 border-left-primary">
                        <div class="card-body">
                            <h4 class="m-0 font-weight-bold text-primary">Mantenimiento de tipo de identificacion</h4>
                            <asp:LinkButton ID="btnNew" CssClass="btn btn-primary btn-icon-split" Text="<span class='icon text-white-50'><i class='fas fa-file'></i></span><span class='text'>Nuevo</span>" runat="server" OnClick="btnNew_Click" ToolTip="Nuevo tipo de identificación"></asp:LinkButton>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <asp:GridView CssClass="table table-borderless table-sm table-hover table-striped" HeaderStyle-CssClass="thead-dark" ID="gvMain" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvMain_RowDataBound" AllowPaging="True" OnRowEditing="gvMain_RowEditing" OnRowCancelingEdit="gvMain_RowCancelingEdit" OnRowDeleting="gvMain_RowDeleting" OnRowUpdating="gvMain_RowUpdating" OnPageIndexChanging="gvMain_PageIndexChanging">
                                    <Columns>
                                        <asp:BoundField DataField="TipoIdentificacionID" HeaderText="ID" ReadOnly="True" />
                                        <asp:BoundField DataField="Nombre" HeaderText="Nombre tipo de Identificación" />
                ...
                <asp:View ID="viewForm" runat="server">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Formulario tipo de identificación</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="form-group">
                                    <asp:TextBox ID="txtNombre" CssClass="form-control form-control-user" runat="server" placeholder="Ingrese el nombre del tipo de identificación" TextMode="SingleLine" MaxLength="200"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Debe ingresar el nombre del tipo de identificación" Display="Dynamic" 
