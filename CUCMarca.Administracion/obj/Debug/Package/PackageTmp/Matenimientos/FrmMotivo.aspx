<%@ Page Title="" Language="C#" MasterPageFile="~/CUC.Master" AutoEventWireup="true" CodeBehind="~/Matenimientos/FrmMotivo.aspx.cs" Inherits="CUCMarca.Administracion.Matenimientos.FrmMotivo" %>
            ...
            <asp:MultiView ID="mvMain" runat="server">
                <asp:View ID="viewDatos" runat="server">
                    <div class="card mb-4 py-3 border-left-primary">
                       ...
                       <div class="card-body">
                            <h4 class="m-0 font-weight-bold text-primary">Mantenimiento de Motivos</h4>
                ...
                <asp:View ID="viewForm" runat="server">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Formulario Motivo</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Debe ingresar el nombre del motivo" Display="Dynamic" 
