    ...
    public partial class FrmMotivo : System.Web.UI.Page
    {
        ...
        private void CargarMotivo()
        {
            try
            {
                ...
                foreach (respuesta b in getMotivos())
                {
        ...
        public List<respuesta> getMotivos()
        {

            List<respuesta> lista = new List<respuesta>();

            string url = ConfigurationManager.AppSettings["APIurl"] + "/api/Motivoes";
            ...
            using (var client = new HttpClient())
            {
                ...
                else if (message.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    lista = JsonConvert.DeserializeObject<List<respuesta>>(task2.Result);
