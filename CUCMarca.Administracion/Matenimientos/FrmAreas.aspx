<%@ Page Title="" Language="C#" MasterPageFile="~/CUC.Master" AutoEventWireup="true" CodeBehind="FrmAreas.aspx.cs" Inherits="CUCMarca.Administracion.Matenimientos.FrmAreas" %>
            ...
            <asp:MultiView ID="mvMain" runat="server">
                <asp:View ID="viewDatos" runat="server">
                    <div class="card mb-4 py-3 border-left-primary">
                        <div class="card-body">
                            <h4 class="m-0 font-weight-bold text-primary">Mantenimiento de Areas</h4>
                            ...
                            <div class="table-responsive">
                                <asp:GridView CssClass="table table-borderless table-sm table-hover table-striped" HeaderStyle-CssClass="thead-dark" ID="gvMain" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvMain_RowDataBound" AllowPaging="True" OnRowEditing="gvMain_RowEditing" OnRowCancelingEdit="gvMain_RowCancelingEdit" OnRowDeleting="gvMain_RowDeleting" OnRowUpdating="gvMain_RowUpdating" OnPageIndexChanging="gvMain_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Jefe de Área">
                                            <ItemTemplate>
                                                <asp:Label ID="Label2" runat="server" Text='<%# ObtenerNombreJefeArea(int.Parse(Eval("Jefe").ToString()))  %>'></asp:Label>
                                            </ItemTemplate>
                                             <EditItemTemplate>
                                                <asp:DropDownList ID="ddljefeGrid" DataSource='<%# listaJefeArea %>' DataTextField="nombrecompleto" DataValueField="codigofuncionario" CssClass="form-control form-control-user" runat="server">
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                            
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Tipo de Área">
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# ObtenerNombreTipoArea(int.Parse(Eval("TipoAreaID").ToString()))  %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:DropDownList ID="ddlTipoAreaGrid" DataSource='<%# listaTipoArea %>' DataTextField="Nombre" DataValueField="TipoAreaID" CssClass="form-control form-control-user" runat="server">
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                ...
                <asp:View ID="viewForm" runat="server">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Formulario área</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="form-group">
                                    <asp:TextBox ID="txtNombre" CssClass="form-control form-control-user" runat="server" placeholder="Ingrese el nombre del área" TextMode="SingleLine" MaxLength="200"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Debe ingresar el nombre del área" Display="Dynamic" 
                                        SetFocusOnError="true" CssClass="text-danger" ControlToValidate="txtNombre"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group">
                                    <asp:DropDownList ID="ddlTipoArea" CssClass="form-control form-control-user" runat="server">
                                    </asp:DropDownList>
                                    <asp:CompareValidator ControlToValidate="ddlTipoArea" ID="CompareValidator1"
                                ...
                                <!-- lista jefe de area-->
                                <div class="form-group">
                                    <asp:DropDownList ID="ddlJefeArea" CssClass="form-control form-control-user" runat="server">
                                    </asp:DropDownList>
                                    <asp:CompareValidator ControlToValidate="ddlJefeArea" ID="CompareValidator2"
                                        CssClass="text-danger" ErrorMessage="Seleccione el jefe de área"
                                        runat="server" Display="Dynamic"
                                        Operator="NotEqual" ValueToCompare="0" Type="Integer" />
                                </div>
                            </div>
